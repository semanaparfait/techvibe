  ...
  return (
    <section>
        ...
        <div className='hero-content flex flex-col gap-2  h-full'>
          <div class="absolute -top-40 -right-20 w-96 h-96 
            bg-green-600 
            opacity-10
            rounded-full 
            mix-blend-screen 
...
<br /><br />
        <div className='flex items-center justify-center gap-4 cursor-pointer '>
          ...
          <button className="flex items-center cursor-pointer gap-2 text-white font-semibold py-2 px-4 md:py-2.5 md:px-6 md:text-base border border-green-400 rounded-3xl hover:bg-green-500 hover:text-black hover:shadow-[0_0_15px_#22c55e] transition-all duration-300 ease-in-out">
